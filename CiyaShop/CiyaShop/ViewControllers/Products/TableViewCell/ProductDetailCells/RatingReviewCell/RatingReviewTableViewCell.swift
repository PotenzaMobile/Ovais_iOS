...
class RatingReviewTableViewCell: UITableViewCell {
    ...
    func setUpData()
    {
        ...
        //--
        /*lblRatingCount.attributedText = lblTotalRating.setUpMultiUILabel(color1: normalTextColor, color2: grayTextColor, str1: "\(dictDetails["rating_count"].stringValue)", str2: " \(getLocalizationString(key: "Ratings"))",font1: UIFont.appBoldFontName(size: fontSize12),font2: UIFont.appRegularFontName(size: fontSize12))
       //--
       lblReviewCount.attributedText = lblTotalRating.setUpMultiUILabel(color1: normalTextColor, color2: grayTextColor, str1: "8 ", str2: getLocalizationString(key: "Reviews"),font1: UIFont.appBoldFontName(size: fontSize12),font2: UIFont.appRegularFontName(size: fontSize12))
        */

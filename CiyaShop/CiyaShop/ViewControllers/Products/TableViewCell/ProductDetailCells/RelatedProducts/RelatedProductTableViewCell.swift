...
//        }
    ...
    /*override func systemLayoutSizeFitting(_ targetSize: CGSize, withHorizontalFittingPriority horizontalFittingPriority: UILayoutPriority, verticalFittingPriority: UILayoutPriority) -> CGSize {
        ...
        print("Related product height - ",self.cvRelatedProducts.contentSize.height)
        cvHeightConstraint.constant = self.cvRelatedProducts.contentSize.height
        return  CGSize(width: screenWidth, height: self.cvRelatedProducts.contentSize.height+54)
    }*/

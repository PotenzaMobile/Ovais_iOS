...
//        self.lblQuantityValue.textColor = secondaryColor
        ...
        vwPaymentDetails.layer.borderColor = UIColor.hexToColor(hex: "#E3E4E6").cgColor//UIColor.lightGray.cgColor
        vwPaymentDetails.layer.borderWidth = 0.5
        vwPaymentDetails.layer.cornerRadius = 5
        
        vwBillingAddress.layer.borderColor = UIColor.hexToColor(hex: "#E3E4E6").cgColor//UIColor.lightGray.cgColor
        vwBillingAddress.layer.borderWidth = 0.5
        vwBillingAddress.layer.cornerRadius = 5
        
        vwShippingAddress.layer.borderColor = UIColor.hexToColor(hex: "#E3E4E6").cgColor//UIColor.lightGray.cgColor
...
//        self.lblQuantityValue.text = orderDetail!["line_items"][0]["quantity"].stringValue
...
//            self.lblOrderStatus.text = getLocalizationString(key: "Delivered").uppercased()
            self.vwOrderStatus.backgroundColor = .systemGreen

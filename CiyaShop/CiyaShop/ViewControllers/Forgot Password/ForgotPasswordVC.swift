...
//                    showCustomAlert(title: APP_NAME,message: message, vc: self.viewContainingController()!)
                } else {
                    self.viewContainingController()!.showToast(message: getLocalizationString(key: "technicalIssue"))
//                    showCustomAlert(title: APP_NAME,message: getLocalizationString(key: "technicalIssue"), vc: self.viewContainingController()!)
                }
            }
        }
    }

...
//            addressParams["country"] = dictLoginData["billing"]["country"].stringValue
//            addressParams["state"] = dictLoginData["billing"]["state"].stringValue
            addressParams["phone"] = txtPhoneNumber.text
//            addressParams["email"] = dictLoginData["email"].stringValue
            
            params!["billing"] = addressParams
            
        } else {
//            addressParams["country"] = dictLoginData["shipping"]["country"].stringValue
//            addressParams["state"] = dictLoginData["shipping"]["state"].stringValue
...
//            if item["key"] == "mobile" {
//                params!["mobile"] = item["value"]
//            } else if item["key"] == "dob" {
//                params!["dob"] = item["value"]

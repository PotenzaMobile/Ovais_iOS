...
//        let imageUrl = arrProducts[indexPath.row]["app_thumbnail"].string
//
////        DispatchQueue.global(qos: .userInitiated).async {
//            cell.imgProduct.sd_setImage(with: imageUrl!.encodeURL() as URL) { (image, error, cacheType, imageURL) in
////                DispatchQueue.main.async {
//                    if (image == nil) {
//                        cell.imgProduct.image =  UIImage(named: "noImage")
//                    } else {
//
...
//        if let productTitle = arrProducts[indexPath.row]["name"].string {
//            cell.lblProductName.text = productTitle
//        } else if let productTitle = arrProducts[indexPath.row]["title"].string {
//            cell.lblProductName.text = productTitle
//        } else {
//            cell.lblProductName.text = " "
//        }
//
//        let priceValue = arrProducts[indexPath.row]["price_html"].string!.withoutHtmlString()
//        if priceValue == "" {
//            cell.lblPrice.text = " "
//        } else {
//            cell.lblPrice.setPriceForItem(arrProducts[indexPath.row]["price_html"].string!)
//        }
        
//        cell.ratingView.rating = Double(arrProducts[indexPath.row]["rating"].string!)!
                
//        if let inStock = arrProducts[indexPath.row]["in_stock"].bool {
//            if inStock == true {
//                cell.btnAddtoCart.backgroundColor = secondaryColor
//                cell.btnAddtoCart.addTarget(self, action: #selector(btnAddtoCartClicked(_:)), for: .touchUpInside)
//            } else {
//                cell.btnAddtoCart.removeTarget(self, action: #selector(btnAddtoCartClicked(_:)), for: .touchUpInside)
//                cell.btnAddtoCart.backgroundColor = .red
//            }
//        } else {
//            cell.btnAddtoCart.removeTarget(self, action: #selector(btnAddtoCartClicked(_:)), for: .touchUpInside)
//            cell.btnAddtoCart.backgroundColor = .red
...
//
//                if checkItemExistsInCart(productId: arrProducts[indexPath.row]["id"].stringValue) {
//                    cell.btnAddtoCart.setImage(UIImage(named: "select-icon"), for: .selected)
//                    cell.btnAddtoCart.isSelected = true
//                } else {
//                    cell.btnAddtoCart.setImage(UIImage(named: "cart-icon"), for: .normal)
...
//                }
//
//                if let price = arrProducts[indexPath.row]["price"].double {
//                    if price == 0 {
//                        cell.btnAddtoCart.isHidden = true
//                    } else {
//                        cell.btnAddtoCart.isHidden = false

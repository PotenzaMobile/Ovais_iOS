...
class MyPointsVC: UIViewController {
    ...
    var arrPoints =  Array<JSON>()//[["event":"Points expired","date":"Sep 11, 2020","points":"-100"],["event":"Points earned for account signup","date":"Sep 10, 2020","points":"100"]]
...
//        self.tblMyPoints.layer.borderWidth = 0.5
        self.cvMyPoints.layer.cornerRadius = 5
//        self.cvMyPoints.sizeToFit()

...
//
//        if(arrVariations.count > 0 && arrSelectedVariationOption.count > 0) {
//            let arraySearchSelectedVariation = arrVariations.filter { (json) -> Bool in
//                let aryLocalAttributes = json["attributes"].arrayValue
//                var arrayCheckAttributes : [Any] = []
//
//                if aryLocalAttributes.contains(where: { (atrJson) -> Bool in
//                    if(arrSelectedVariationOption.contains(where: { (anyObj) -> Bool in
//
//                        if(anyObj as? String ?? "" == atrJson["option"].stringValue){
//                            arrayCheckAttributes.append(atrJson["option"].stringValue)
//                            return true
//                        }
//                        return false
//                    })){
//                        if(arrayCheckAttributes.count == arrSelectedVariationOption.count){
//                            return true
//                        }
//                        return false
//                    }
...
//            }
//
//            print("arraySearchSelectedVariation - ",arraySearchSelectedVariation)
//            var inStock = false
//            if(arraySearchSelectedVariation.count > 0)
//            {
//                let dictLocalProductDetail = arraySearchSelectedVariation[0]
//                selectedVariationJson = dictLocalProductDetail
//                if(dictLocalProductDetail["in_stock"].boolValue)
//                {
//                    doneButtonInStockUI()
//                }else{
//                    doneButtonOutStockUI()
